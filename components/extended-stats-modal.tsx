...
export function ExtendedStatsModal({ isOpen, onClose, matches, filters }: ExtendedStatsModalProps) {
  ...
  const hasActiveFilters = filters.homeTeam || filters.awayTeam || filters.btts || filters.comeback
      ...
      <div className="relative mx-auto my-10 w-full max-w-3xl px-4">
        <div className="rounded-2xl ring-1 ring-white/10 bg-[#0c0f16] shadow-2xl overflow-hidden">
          <div className="px-6 pt-6 pb-4 border-b border-white/10">
            ...
            {hasActiveFilters && (
              <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-violet-500/10 text-violet-300 ring-1 ring-violet-400/30 px-3 py-1.5 text-xs">
